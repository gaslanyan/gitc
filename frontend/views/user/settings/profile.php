    ...
    <div class="col-md-9" style="margin-top: 20px">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?= $form->field($model, 'fileHeader')->fileInput(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-9">
                        <?php
                        if ($model->image_header) {
                            echo '<img src="' . \Yii::$app->request->BaseUrl . '/' . $model->image_header . '" width="90px">&nbsp;&nbsp;&nbsp;';
                            echo Html::a('Delete Image', ['deleteimg', 'id' => $model->user_id, 'field' => 'image_header'], ['class' => 'btn btn-danger']) . '<p>';
                        }
                        ?>
                    </div>
                </div>
