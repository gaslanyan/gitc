                            ...
                            try {
                                if ($flag = $modelClassified->save(false)) {
                                    ...
                                    foreach ($modelImage as $i => $modelImage) {
                                        ...
                                        $modelImage->imageFile = UploadedFile::getInstance($modelImage,
                                            "[$i]imageFile");
                                ...
                                if ($flag) {
                                    ...
                                    \Yii::$app->getSession()->setFlash('success',
                                        '<div class="alert d-alert-success" role="alert"><b>Thank you, your ads successfully saved!</b></div>');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($modelClassified->load(Yii::$app->request->post())) {
            ...
            $deletedIDs = array_diff($oldIDs,
                array_filter(\yii\helpers\ArrayHelper::map($modelImage, 'id', 'classified_id')));
                    ...
                    if ($flag = $modelClassified->save(false)) {
                        ...
                        foreach ($modelImage as $i => $modelImage) {
                            ...
                            if (empty($modelImage->imageFile)) {
                                $name = Yii::$app->security->generateRandomString();
                                $modelImage->imageFile = \yii\web\UploadedFile::getInstance($modelImage,
                                    "[$i]imageFile");
